...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46225  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rasilkc'  \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env MQTTUSERNAME='Rasilkc'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 55901:55901 -p 58267:58267 -p 38401:38401 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=myprojecttwo-fb1a \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a \-\-env GITUSERNAME=Rasilkc  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=55901  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=58267  \-\-env SOLUTIONVIPERVIZPORT=38401 \-\-env DOCKERUSERNAME='rasilkc98' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=46225 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='Rasilkc' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rasilkc98/myprojecttwo-fb1a-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55901, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44503, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=46063, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33617, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37657, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42167, HPDEHOST=127.0.1.1, HPDEPORT=39061, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39441

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1321-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-preprocess-1734-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-ai-1188-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
