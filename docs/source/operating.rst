[myprojecttwo-fb1a] Operating Details
====================================

Generated On: 2024-11-28 22:06:38 UTC
...
.. important::
   ...
   **not be valid if your [myprojecttwo-fb1a] container is NOT running**.

.. tip::
   You must have your [myprojecttwo-fb1a] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Rasilkc/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41179  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rasilkc'  \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env MQTTUSERNAME='Rasilkc'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   rasilkc98/myprojecttwo-fb1a-amd64 (https://hub.docker.com/r/rasilkc98/myprojecttwo-fb1a-amd64)
...
.. code-block::
   ...
   docker run -d -p 56819:56819 -p 58825:58825 -p 47753:47753 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=myprojecttwo-fb1a \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a \-\-env GITUSERNAME=Rasilkc  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=56819  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=58825  \-\-env SOLUTIONVIPERVIZPORT=47753 \-\-env DOCKERUSERNAME='rasilkc98' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=41179 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='Rasilkc' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rasilkc98/myprojecttwo-fb1a-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - rasilkc98/myprojecttwo-fb1a-amd64
...
[myprojecttwo-fb1a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Rasilkc/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myprojecttwo-fb1a
...
.. important::
   https://myprojecttwo-fb1a.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=56819, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37317, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43343, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42191, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43473, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34025, HPDEHOST=127.0.1.1, HPDEPORT=42111, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41893

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-45-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-preprocess-1122-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-ai-8678-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
