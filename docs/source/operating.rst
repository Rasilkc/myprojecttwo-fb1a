...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41667  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rasilkc'  \-\-env DOCKERUSERNAME='rasilkc98'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. code-block::
   ...
   docker run -d -p 55093:55093 -p 40963:40963 -p 42031:42031 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=myprojecttwo-fb1a \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a \-\-env GITUSERNAME=Rasilkc  \-\-env GITREPOURL=https://github.com/Rasilkc/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=55093  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=40963  \-\-env SOLUTIONVIPERVIZPORT=42031 \-\-env DOCKERUSERNAME='rasilkc98' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=41667 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rasilkc98/myprojecttwo-fb1a-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55093, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40441, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33727, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43847, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39681, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38415, HPDEHOST=127.0.1.1, HPDEPORT=42857, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36989

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5744-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-preprocess-4176-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, python-ai-365-myprojecttwo-fb1a,solution_preprocessing_ai_mqtt_dag-myprojecttwo-fb1a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
